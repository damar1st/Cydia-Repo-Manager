...
<!-- End BidVertiser code -->
			...
			<li><a href="#video" target="_blank"><img src="_img/screens.svg" alt="Video" class="ui-li-icon">Video</a></li>
    ...
    <div data-role="content">
        <ul data-role="listview" data-inset="true">
            ...
            <div class="video-container">
              <iframe id="iframe" src="http://www.youtube.com/embed/'.$video.'?rel=0"></iframe>
            </div>            
            </li>
        </ul>
        </div>
